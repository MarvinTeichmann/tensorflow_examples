...
def _make_data_gen(hypes, phase):
...
def start_enqueuing_threads(hypes, q, sess):
    ...
    # Labels
    label_pl = tf.placeholder(tf.float32, shape=[])
    ...
    for phase in ['train', 'test']:
        ...
        gen = _make_data_gen(hypes, phase)
        data = gen.next()
...
def main():
    ...
    with tf.Session() as sess:
        ...
        start_enqueuing_threads(hypes, q, sess)
